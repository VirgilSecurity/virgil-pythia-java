...
main() {
  ...
  ./gradlew :pythia:publishMavenJavaPublicationToCentralBundleRepository :pythia-android:publishMavenJavaPublicationToCentralBundleRepository --no-daemon --stacktrace
